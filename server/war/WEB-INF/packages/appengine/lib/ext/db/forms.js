var db = require("appengine/ext/db");
 ...
 *
 *  var db = require("appengine/ext/db"),
 *      forms = require("appengine/ext/db/forms");
 *
 ...
 *
 * @return {boolean} true if the form contains errors, false otherwise. 
 */
ModelForm.prototype.isValid = function () {
    for (var e in this.errors) return false;
    return true;   
}
...
// -----------------------------------------------------------------------------
// Old stuff, still used, cleanup needed.
