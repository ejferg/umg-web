/**
 * @fileoverview An App Engine application can send and receive instant messages to and from 
 ...
 *       Message = require("appengine/api/xmpp").Message;
 *
...
/** @const */ exports.MESSAGE_TYPE_NONE = "";
/** @const */ exports.MESSAGE_TYPE_CHAT = JMessageType.CHAT;
/** @const */ exports.MESSAGE_TYPE_ERROR = JMessageType.ERROR;
/** @const */ exports.MESSAGE_TYPE_GROUPCHAT = JMessageType.GROUPCHAT;
/** @const */ exports.MESSAGE_TYPE_HEADLINE = JMessageType.HEADLINE;
/** @const */ exports.MESSAGE_TYPE_NORMAL = JMessageType.NORMAL;
...
var Message = exports.Message = function(env) {
    var jmsg = jservice.parseMessage(env["jack.servlet_request"]);   // TODO: Should no longer be using Jack
