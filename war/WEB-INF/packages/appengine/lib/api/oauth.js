...
var User = require("appengine/api/users").User;
...
exports.getCurrentUser = function () {
    return User.fromJavaUser(JOAuthServiceFactory.getOAuthService().getCurrentUser());
};
...
exports.isCurrentUserAdmin = function () {
    return JOAuthServiceFactory.getOAuthService().isUserAdmin();
};
...
exports.getOAuthConsumerKey = function () {
    return JOAuthServiceFactory.getOAuthService().getOAuthConsumerKey();
};
