...
var BadValueError = require("appengine/ext/db/errors").BadValueError;

var TYPES = require("appengine/api/datastore/types"),
    Key = TYPES.Key,
    GeoPt = TYPES.GeoPt;

var utils = require("appengine/utils"),
	users = require("appengine/api/users");
    ...
    if (kind) {
        ...
        Object.defineProperty(constructor.prototype, this.name, {
            get: function () {
                ...
                if (this[resolvedName] == undefined) {
                    var value = require("appengine/ext/db").get(this[idName]);
                    if (!value) throw new Error("ReferenceProperty failed to be resolved");
                    this[resolvedName] = value;
                }
